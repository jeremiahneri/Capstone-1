<div class="container-fluid mb-5" style="height:55vh;" id="blog">
        <h2 class="text-center text-light"
            style="margin-top: 50px;margin-bottom: 50px;font-family: 'Poppins', sans-serif;font-size:3rem;">Our Blog
        </h2>
        <div class="owl-carousel owl-theme" style="width:100%; height:35vh;">
            <div class="item">
                <a href="https://www.youtube.com/watch?v=pDfp0d_GtRM" style="text-decoration: none;">
                    ...
                    <p style="text-align: center; margin-top: 15px; color: white;">"Elevate Your Drive with Our All-New
                        Cars!"</p>
                    <div class="blogMessage" style="display: flex; flex-direction: row; margin-top: 85px;">
            ...
            <div class="item">
                <a href="https://www.youtube.com/watch?app=desktop&v=8D4C7y1YaY8" style="text-decoration: none;">
                    ...
                    <div class="blogMessage" style="display: flex; flex-direction: row; margin-top: 95px;">
            ...
            <div class="item"><iframe width="100%" height="100%"
                ...
                <div class="blogMessage" style="display: flex; flex-direction: row; margin-top:80px;">
