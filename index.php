...
<body>
    ...
    <nav class="navbar navbarMain navbar-expand-lg navbar-light p-4">
        <div class="container-fluid">
            ...
            <div class="collapse navbar1 navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-light" href="log-in.php" style="color: grey; text-decoration: white; border: 1px solid transparent; border-radius: 5px; padding: 5px 10px;" 
                    onmouseover="this.style.borderColor='white';" onmouseout="this.style.borderColor='transparent';">Sign In
                    </a>
                </li>
                    <li class="nav-item">
                <a class="nav-link text-light" href="sign-up.php" style="text-decoration-color: white; border: 1px solid white; border-radius: 5px; padding: 5px 10px; color: white;" 
        ...
        <div id="carouselExample" class="carousel slide" carousel-fade data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    ...
                    <div class="overlay">
                        <h2 class="h2Text"  style="wdith: 50px; font-size:50px">"Upgrade your ride for less – book a premium car rental and get a free weekend day on us."</h2>
                    </div>
                </div>
    ...
    <div class="container mainContainer">
        <div class="title_main2">
            <h2 class="text-left text-light" style="text-align:left;">GET STARTED WITH 4 SIMPLE STEPS</h2>
        </div>
        <div class="row">
            <div class="step1 col-md-3">
                <div class="card cardSect4" style="height: 100%;">
                    ...
                    <p class="step1__text" style="font-size:15px; width:150px; text-align: center; margin: 0 auto; margin-top:10px;  margin-bottom:5px;">Register on our platform to access a personalized car rental experience.</p>
                </div>
            ...
            <div class="step1 col-md-3">
                <div class="card cardSect4" style="height: 100%;">
                    ...
                    <p class="step1__text" style="font-size:15px; width:170px; text-align: center; margin: 0 auto; margin-top:10px;  margin-bottom:5px;">Specify your preferred car model, rental period, and pick-up location.</p>
                </div>
            ...
            <div class="step1 col-md-3">
                <div class="card cardSect4" style="height: 100%;">
                    ...
                    <p class="step1__text" style="font-size:15px; width:170px; text-align: center; margin: 0 auto; margin-top:10px; margin-bottom:5px;">Our algorithm will match you with the best available car rental options.</p>
                </div>
            ...
            <div class="step1 col-md-3">
                <div class="card cardSect4" style="height: 100%;">
                    ...
                    <p class="step1__text" style="font-size:15px; width:190px; text-align: center; margin: 0 auto; margin-top:10px;  margin-bottom:5px;">Finalize the rental agreement with the car owner and enjoy your hassle-free
                        ride.</p>
                </div>
            </div>
        </div>
    ...
    <div class="container"  style="height:55vh;">
        <h2 class="text-left text-light" style="margin-top: 50px; font-size: 40px; margin-bottom: 50px;">Our Blog</h2>
